package com.emergentideas.webhandle.apps.oak.emailtemplates;
...
public class EmailAddressTemplate implements TemplateInstance {
	...
	public void render(SegmentedOutput output, Location location, String elementSourceName, String... processingHints) {
		...
		generateAddress(addrObj, output.getStream(elementSourceName));
	}
	
	protected void generateAddress(Object addrObj, StringBuilder sb) {
		String addr = null;
		String name = null;
		if(addrObj != null) {
